...
public final class SubTabCasualtyGui extends TabBase {
    ...
    public SubTabCasualtyGui(Local local) {
        ...
        controler = new CasualtyControler(this, local);
        //configura grid
        ...
        comboFiltroTactic.setModel(controler.listFiltroTactic());

        //adiciona listeners
        comboFiltro.addActionListener(controler);
        comboFiltroTactic.addActionListener(controler);

        TableModel model = controler.getMainTableModel(getFiltro(), getFiltroTactic());
