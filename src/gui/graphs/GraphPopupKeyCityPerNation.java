 ...
 * @author jmoura
 */
public class GraphPopupKeyCityPerNation {

    private static final Log log = LogFactory.getLog(GraphPopupKeyCityPerNation.class);
    ...
    private void initFX(JFXPanel fxPanel) {
        ...
        window.setTitle(labels.getString("PONTOS.KEYCITY.NATION"));
