...
//        }
    ...
    private ImageIcon getMovementTagIcon(int custoMov, int limitMov, MovimentoExercito move, boolean cumulativeCounter) {
        ...
        /**
         * Draw a slightly larger black circle first to give the impression of a
         * dark border
         */
...
//        g.fillOval(21, 21, 19, 19);
    ...
    public void setTag() {
        ...
        getTagLabel().setOpaque(false);
        if (SettingsManager.getInstance().getConfig("HexTagFrame", "0").equals("1")) {
            getTagLabel().setBorder(javax.swing.BorderFactory.createEtchedBorder());
        } else {
            getTagLabel().setBorder(javax.swing.BorderFactory.createEmptyBorder());
        }
    }
    ...
    private JLabel getTagLabel() {
        return tagLabel;
    }

    private void setTagLabel(ImageIcon tagIcon) {
        if (this.tagLabel == null) {
            this.tagLabel = new JLabel(tagIcon);
        } else {
            this.tagLabel.setIcon(tagIcon);
        }
    }
}
