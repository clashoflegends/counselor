 ...
 */
public class LineChartDemoB extends ApplicationFrame {
     ...
     */
    public LineChartDemoB(String title) {
        super(title);
    ...
    private static JFreeChart createChart(CategoryDataset dataset) {
        ...
        URL imageURL = LineChartDemoB.class.getClassLoader().getResource(
                "OnBridge11small.png");
        if (imageURL != null) {
    ...
    public static void main(String[] args) {
        LineChartDemoB demo = new LineChartDemoB(
